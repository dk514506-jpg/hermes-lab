...
- Image-only sources (A1-07 Stiegler, A1-11 Winner, A1-14 Mitcham, A1-16 Mumford) were charted supplemented by secondary synthesis (Philpapers abstract, independent summaries, publisher pages). Flag as "image-only" or "abstract-level" in Discovery Notes and record verification debt.

...
COPY FOR PHASE 10 INTEGRATION — provenance
Original: ~/.hermes/hermes-agent/docs/faos_engine_extension.py
Copied 2026-08-07 into Phase10_Integration/ so the merged estate is
self-contained (the FAOS gateway engine is now an in-estate dependency).
Do not edit the original from here; this copy is the integration base.
